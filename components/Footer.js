...
const ThemeSwitcher = () => {
  return (
    <div className="flex items-center bg-white justify-center dark:bg-gray-900 rounded-3xl py-1 px-2">
      <button
        type="button"
        ...
        className="flex items-center h-full pr-2 dark:bg-primary rounded-3xl flex justify-center align-center p-2 w-12 h-10 transition"
      >
        {moonIcon}
      </button>
