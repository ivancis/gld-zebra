  ...
  return (
    <Layout>
      ...
      <main className="w-full">
        ...
        <div class="max-w-7xl w-full mx-auto flex flex-wrap justify-center gap-4 p-2">
          <div class="max-w-sm w-full p-6 rounded-lg backdrop-blur-xl bg-white dark:bg-black dark:bg-opacity-40 bg-opacity-30">
        ...
        <div class="px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
          <div class="flex flex-col md:flex-row flex-wrap gap-8 justify-center">
            ...
            <div class="text-center">
              <h6 class="text-3xl font-bold text-deep-purple-accent-400">NN years</h6>
